...
abstract contract ETHPriceOracle is PrimaryProdDataServiceConsumerBase, AuthorisedMockSignersBase, Initializable {
    ...
    function getAuthorisedSignerIndex(address _signer) public view override returns (uint8) {
